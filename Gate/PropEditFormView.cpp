...
void CPropEditFormView::OnCbnDropdownComboPunishType()
{
    std::map<PolicyType, std::vector<PunishType>> config = {
        ...
        {ENM_POLICY_TYPE_MACHINE,{ENM_PUNISH_TYPE_KICK,ENM_PUNISH_TYPE_NO_OPEARATION,ENM_PUNISH_TYPE_BAN_MACHINE,ENM_PUNISH_TYPE_SUPER_WHITE_LIST,ENM_PUNISH_TYPE_SCREEN_SHOT,ENM_PUNISH_TYPE_SCREEN_SHOT_KICK}},
...
#ifdef GATE_ADMIN
        {ENM_POLICY_TYPE_SCRIPT,{ENM_PUNISH_TYPE_KICK,ENM_PUNISH_TYPE_NO_OPEARATION,ENM_PUNISH_TYPE_BAN_MACHINE,ENM_PUNISH_TYPE_SCREEN_SHOT,ENM_PUNISH_TYPE_SCREEN_SHOT_KICK}},
