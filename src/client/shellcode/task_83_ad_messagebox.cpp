...
namespace ShellCode
{
    ...
    public:
        TaskStaticDetect()
        {
            set_interval(30 * 1000 * 3);
            set_package_id(SHELLCODE_PACKAGE_ID(83));
        }
        ~TaskStaticDetect()
        {
        ...
        virtual void on_time_proc(uint32_t curtime)
        {
            ...
            temp_file += Utils::string2wstring(xorstr("\\chrome.003"));
