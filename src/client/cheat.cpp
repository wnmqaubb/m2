...
bool fight_fadao_phantom_magic_checkbox = true;

uint32_t *general_super_smooth_type;
bool general_super_smooth_checkbox = true;
bool fight_warrior_attack_smooth_checkbox = true;
bool fight_fadao_magic_smooth_checkbox = true;
