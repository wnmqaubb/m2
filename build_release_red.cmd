...
set gm_server=%OutputDir%gm_server_red\%2
set admin_server=%OutputDir%admin_server\%2
mkdir %gm_server%
::echo ***************gm_server***************
VMProtect_Con.exe %ReleaseDir%\Service.exe %gm_server%\g_Service.exe -pf ServiceRelease_red.vmp
VMProtect_Con.exe %ReleaseDir%\LogicServer.exe %gm_server%\g_LogicServer.exe -pf LogicRelease_red.vmp
VMProtect_Con.exe %ReleaseDir_red%\GateF.exe %gm_server%\º∞ ±”Í∫Ë√…∞Ê.exe -pf GateRelease_red.vmp
