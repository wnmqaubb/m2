...
::echo ***************gm_server***************
VMProtect_Con.exe %ReleaseDir%\Service.exe %gm_server%\Service.exe -pf ServiceRelease.vmp
VMProtect_Con.exe %ReleaseDir%\LogicServer.exe %gm_server%\LogicServer.exe -pf LogicRelease.vmp
VMProtect_Con.exe %ReleaseDir%\Gate.exe %gm_server%\Gate.exe -pf GateRelease.vmp
